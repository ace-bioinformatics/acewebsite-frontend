  ...
  fields: [
    ...
    defineField({
      ...
      options: {
        list: [
          {title: 'AMR', value: 'amr'},
          {title: 'Human Genomics & Cancer', value: 'human_genomics_and_cancer'},
          {title: 'Malaria', value: 'malaria'},
          {title: 'High Performance Computing', value: 'hpc'},
          {title: 'Training & Capacity Building', value: 'capacity_building_and_training'},
          {title: 'AI & Machine Learning', value: 'ai_and_machine_learning'},
