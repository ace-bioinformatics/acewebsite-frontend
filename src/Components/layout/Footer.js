...
const footerNavigation = {
  ...
  research: [
    ...
    { name: 'Collaborations', href: '/about#partnerships' },
  ],
  academic: [
                ...
                <ul role="list" className="mt-6 space-y-4">
                  {footerNavigation.about.map((item) => (
                    <li key={item.name}>
                      <Link
                        href={item.href}
                        className="text-sm leading-6 text-gray-300 hover:text-red-500 transition-colors"
                      >
                        {item.name}
                      </Link>
                    </li>
        ...
        <div className="mt-16 border-t border-gray-800 pt-8 sm:mt-20 lg:mt-24">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            ...
            <div className="mt-4 flex space-x-6 md:mt-0">
              <Link href="/privacy" className="text-xs leading-5 text-gray-400 hover:text-red-500 transition-colors">
                Privacy Policy
              </Link>
              <Link href="/terms" className="text-xs leading-5 text-gray-400 hover:text-red-500 transition-colors">
                Terms of Service
              </Link>
            </div>
          </div>
